...
VALUES
    ('1', 'Project Manager', 'Microsoft', 'www.microsoft.com', 'Oversee large projects', '2025-02-16', 'rejected', 'Was sent a rejection email', '2025-02-28'),
    ('4', 'Senior Software Engineer', 'Apple', 'www.apple.com', 'Collaborate and write programs, train new employees', '2025-01-29', 'accepted', 'Received an offer', '2025-02-15'),
    ('2', 'Junior Software Engineer', 'Google', 'www.google.com', 'Collaborate and write programs', '2025-02-04', 'need-to-apply', 'None', '2025-02-14'),
    ('3', 'Programmer Analyst', 'Meta', 'www.meta.com', 'Test and maintain programs', '2025-02-10', 'interviewing', 'Got an interview', '2025-02-18'),
    ('4', 'Summer Internship', 'Costco', 'https://phf.tbe.taleo.net/phf02/ats/careers/v2/jobSearch?act=redirectCwsV2&cws=41&org=COSTCO', 'The International IT team leverages modern enterprise programming languages, frameworks, and infrastructure to build innovative solutions for supporting Costco''s business internationally in countries outside of the USA.', '2025-03-07', 'applied', 'waiting for a response', '2025-03-21');
...
INSERT INTO `announcements` (`title`, `job_type`, `location`, `ename`, `additional_info`, `jurl`, `sent_to`, `date_created`)
    VALUES
        ('Partner Engineer, Android', 'job', 'Bellevue, WA', 'Meta', 'Partner Engineering is a highly technical team that works with our strategic partners to integrate Meta products into their mobile platforms, apps, devices as well as our VR/AR platforms. Partner Engineers bring deep technical knowledge of Android platforms to lead highly visible initiatives and launch impactful products with our strategic mobile partners.', 'https://www.metacareers.com/jobs/917060759860304', '', '2025-02-17'),
        ('Software Engineer 2', 'job', 'Redmond, WA', 'Microsoft', 'Design, implement, validate, and release software features to critical production components. Maintain scalable services with health monitoring to enable self-healing systems. Engage with teammates and partner teams to understand business needs to maximize impact. Provide technical, end-to-end ownership for projects on which you work. Innovate and Implement system to enable growth of scalable, critical, and global services. Drive our collaborative, inclusive and passionate team culture.', 'https://jobs.careers.microsoft.com/global/en/job/1672687', '', '2025-02-15'),
        ('Incubation Senior Gameplay Engineer', 'job', 'Hybrid / Bungie-Approved Remote Locations', 'Bungie', '', 'https://careers.bungie.com/jobs/5087300/incubation-senior-gameplay-engineer', '', '2025-03-02'),
        ('Software Dev', 'internship', 'Redmond, WA', 'Costco', '', 'https://www.costco.com/', '', '2025-03-01'),
        ('IT Support', 'internship', 'Seattle, WA', 'REI', 'REI is united around discovering, building, and celebrating better ways of working in this world, all so that our employees and members can find and pursue a love of the outdoors. As a co-op, we are committed to becoming a fully inclusive, antiracist, multicultural organization. When you work for the co-op, you do your best work with the support to live your best life. And you play a part in shaping the future of the outdoors, for people and our planet.', 'https://www.rei.jobs/careers-home', '', '2025-02-13');
